...
type PolicyLister interface {
	...
	List(selector labels.Selector) (ret []*policiesv1beta1.Policy, err error)
...
type policyLister struct {
	listers.ResourceIndexer[*policiesv1beta1.Policy]
}

// NewPolicyLister returns a new PolicyLister.
func NewPolicyLister(indexer cache.Indexer) PolicyLister {
	return &policyLister{listers.New[*policiesv1beta1.Policy](indexer, policiesv1beta1.Resource("policy"))}
}

// Policies returns an object that can list and get Policies.
func (s *policyLister) Policies(namespace string) PolicyNamespaceLister {
	return policyNamespaceLister{listers.NewNamespaced[*policiesv1beta1.Policy](s.ResourceIndexer, namespace)}
}
...
type PolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*policiesv1beta1.Policy, error)
