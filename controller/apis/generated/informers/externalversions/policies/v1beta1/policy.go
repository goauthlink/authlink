...
import (
	...
	versioned "github.com/goauthlink/authlink/controller/apis/generated/clientset/versioned"
	...
	policiesv1beta1 "github.com/goauthlink/authlink/controller/apis/generated/listers/policies/v1beta1"
	apispoliciesv1beta1 "github.com/goauthlink/authlink/controller/apis/policies/v1beta1"
...
type PolicyInformer interface {
	...
	Lister() policiesv1beta1.PolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AuthlinkV1beta1().Policies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AuthlinkV1beta1().Policies(namespace).Watch(context.TODO(), options)
			},
		},
		&apispoliciesv1beta1.Policy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apispoliciesv1beta1.Policy{}, f.defaultInformer)
}

func (f *policyInformer) Lister() policiesv1beta1.PolicyLister {
	return policiesv1beta1.NewPolicyLister(f.Informer().GetIndexer())
}
